...
module SBOM
  module CycloneDX
    Component = SchemaObject.build("Component") do
      ...
      prop :scope, String, enum: Enum::SCOPE, default: Scope::REQUIRED
      ...
      prop :crypto_properties, CryptoProperty
      ...
      Pedigree = SchemaObject.build("Pedigree") do
