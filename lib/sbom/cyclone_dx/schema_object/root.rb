...
module SBOM
  module CycloneDX
    Root = SchemaObject.build("Root") do
      ...
      prop :serial_number, String, pattern: Pattern::URN_UUID, default: -> { "urn:uuid:#{SecureRandom.uuid}" }
      ...
      prop :dependencies, Set[Dependency]
      ...
      prop :compositions, Set[Composition]
      ...
      prop :annotations, Set[Annotation]
      ...
      prop :bom_format, String, required: true, const: true, default: "CycloneDX"

      prop :spec_version, String, required: true, const: true, default: "1.6"
    end
  end
end
