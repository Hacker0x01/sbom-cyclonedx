...
FactoryBot.define do
  ...
  factory :licensing, parent: :schema_object, class: "SBOM::CycloneDX::License::Licensing" do
    trait :all_fields do
  ...
  factory :licensor, parent: :schema_object, class: "SBOM::CycloneDX::License::Licensing::Licensor" do
    transient do
  ...
  factory :licensee, parent: :schema_object, class: "SBOM::CycloneDX::License::Licensing::Licensee" do
    transient do
  ...
  factory :purchaser, parent: :schema_object, class: "SBOM::CycloneDX::License::Licensing::Purchaser" do
    transient do
