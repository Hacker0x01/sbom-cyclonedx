...
FactoryBot.define do
  ...
  factory :custom_phase, parent: :schema_object, class: "SBOM::CycloneDX::Metadata::CustomPhase" do
  ...
  factory :pre_defined_phase, parent: :schema_object, class: "SBOM::CycloneDX::Metadata::PreDefinedPhase" do
