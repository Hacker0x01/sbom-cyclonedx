...
FactoryBot.define do
  ...
  factory(
    ...
    class: "SBOM::CycloneDX::CryptoProperties::AlgorithmProperties"
  ) do
    trait :all_fields do
  ...
  factory(
    ...
    parent: :schema_object,
    class: "SBOM::CycloneDX::CryptoProperties::CertificateProperties"
  ) do
    trait :all_fields do
  ...
  factory(
    :protocol_properties,
    parent: :schema_object,
    class: "SBOM::CycloneDX::CryptoProperties::ProtocolProperties"
  ) do
    trait :all_fields do
  ...
  factory(
    ...
    parent: :schema_object,
    class: "SBOM::CycloneDX::CryptoProperties::ProtocolProperties::IKEv2TransformType"
  ) do
    trait :all_fields do
  ...
  factory(
    ...
    class: "SBOM::CycloneDX::CryptoProperties::RelatedCryptoMaterialProperties"
  ) do
    trait :all_fields do
