  ...
  FactoryBot.define do
    factory :record, class: "SBOM::CycloneDX::Record" do
      ...
      factory :mock_record, class: "SBOM::CycloneDX::Record" do
        ...
        factory :basic_record, class: "SBOM::CycloneDX::MockRecord::Basic", traits: [:string_value]

        factory :all_types_record, class: "SBOM::CycloneDX::MockRecord::AllTypes", traits: %i[
          string_value
          integer_value
          float_value
          boolean_value
        ...
        factory :required_members_record, class: "SBOM::CycloneDX::MockRecord::RequiredMembers" do
          trait :valid do
